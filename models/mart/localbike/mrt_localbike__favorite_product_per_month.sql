WITH products_details_in_orders AS (
    SELECT
        ...
        ROUND(SUM(os.item_quantity * os.item_list_price * (1 - os.item_discount)),2) AS total_amount_in_orders,
...
ranked_products AS (
    SELECT
        *,
        ROW_NUMBER() OVER (PARTITION BY order_year, order_month ORDER BY total_quantity_sold DESC) AS rank
    FROM
